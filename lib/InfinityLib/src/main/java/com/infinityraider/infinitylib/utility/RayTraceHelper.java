...
public class RayTraceHelper {
    ...
    private static Optional<Tuple<Vec3d, Vec3d>> getEyesAndTraceVectors(Entity entity, double distance) {
        ...
        // Vec3d trace = eyes.addVector(look.x * distance, look.y * distance, look.z * distance); deprecated
        Vec3d trace = new Vec3d((look.x*distance) + eyes.x, (look.y*distance) + eyes.y, (look.z*distance) + eyes.z);
        return Optional.of(new Tuple<>(eyes, trace));
    }// new Vec3d(this.x + x, this.y + y, this.z + z);
