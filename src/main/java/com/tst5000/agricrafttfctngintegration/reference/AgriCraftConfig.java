/*
 * AgriCraftTFCTNGIntegration Configuration File
 *
...
public class AgriCraftConfig {
    ...
    @AgriConfigurable(category = AgriConfigCategory.FARMING, key = "Allow other mods to apply bonemeal", comment = "For when a mod uses the IGrowable interface, instead of registering its own fertilizer with AgriCraftTFCTNGIntegration.\nNote: This does not restrict generic update ticks.")
    ...
    @AgriConfigurable(key = "Wipe Grass Drops", category = AgriConfigCategory.FARMING, comment = "Determines if AgriCraftTFCTNGIntegration should completeley override grass drops with those confiured in the JSON files.")
    ...
    @AgriConfigurable(category = AgriConfigCategory.WORLD, key = "Enable villagers", comment = "Set to false if you wish to disable villagers spawning in the AgriCraftTFCTNGIntegration greenhouses.")
