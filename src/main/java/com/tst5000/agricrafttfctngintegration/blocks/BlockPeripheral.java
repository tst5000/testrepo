...
import com.tst5000.agricrafttfctngintegration.renderers.blocks.RenderPeripheral;
...
public class BlockPeripheral extends BlockTileCustomRenderedBase<TileEntityPeripheral> {
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!world.isRemote) {
            player.openGui(AgriCraftTFCTNGIntegration.instance, GuiHandler.PERIPHERAL_GUI_ID, world, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
