...
import com.tst5000.agricrafttfctngintegration.api.v1.fertilizer.IAgriFertilizable;
import com.tst5000.agricrafttfctngintegration.api.v1.fertilizer.IAgriFertilizer;
import com.tst5000.agricrafttfctngintegration.api.v1.items.IAgriClipperItem;
import com.tst5000.agricrafttfctngintegration.api.v1.items.IAgriRakeItem;
import com.tst5000.agricrafttfctngintegration.api.v1.items.IAgriTrowelItem;
import com.tst5000.agricrafttfctngintegration.api.v1.seed.AgriSeed;
import com.tst5000.agricrafttfctngintegration.api.v1.util.MethodResult;
...
import com.tst5000.agricrafttfctngintegration.renderers.blocks.RenderCrop;
...
public class BlockCrop extends BlockTileCustomRenderedBase<TileEntityCrop> implements IGrowable, IPlantable, IHornHarvestable {
    ...
    // =========================================================================
    /**
     * WARNING: You should be using AgriCraftTFCTNGIntegration's IAgriFertilizer interface instead!
     *
     ...
     * parameter is set to true. Uses AgriCraftTFCTNGIntegration's Fertilizer system, specifically whatever adapter
    ...
    private boolean checkOrUseBonemeal(@Nonnull World world, @Nullable Random rand, @Nonnull BlockPos pos, boolean tryToApplyBonemeal) {
        ...
        // Get the AgriCraftTFCTNGIntegration fertilizer representation of bonemeal.
