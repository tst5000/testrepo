...
public class ComponentGui<T extends Container> implements IAgriGui<T> {
    ...
    @AgriConfigurable(key = "Enable GUI Inspector", category = AgriConfigCategory.DEBUG, comment = "Set to true to enable the GUI inspector for all AgriCraftTFCTNGIntegration GUIs.")
