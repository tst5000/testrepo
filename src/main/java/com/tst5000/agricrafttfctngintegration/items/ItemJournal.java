...
import com.tst5000.agricrafttfctngintegration.api.v1.items.IAgriJournalItem;
...
public class ItemJournal extends ItemBase implements IAgriJournalItem, IItemWithModel {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        if (world.isRemote) {
            player.openGui(AgriCraftTFCTNGIntegration.instance, GuiHandler.JOURNAL_GUI_ID, world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
        }
