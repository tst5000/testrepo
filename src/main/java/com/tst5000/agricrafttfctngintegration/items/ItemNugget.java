...
import com.tst5000.agricrafttfctngintegration.reference.AgriNuggetType;
...
public class ItemNugget extends ItemBase implements IAutoRenderedItem, IRecipeRegisterer {
    ...
    public void registerRecipes(IForgeRegistry<IRecipe> registry) {
        for (AgriNuggetType type : AgriNuggetType.values()) {
            ...
            // 2) Conditional recipes. Only if the ingot exists, because AgriCraftTFCTNGIntegration doesn't add its own.
            ...
            if (!ingot.isEmpty()) {
                ...
                final ResourceLocation group = new ResourceLocation(AgriCraftTFCTNGIntegration.instance.getModId(), "combine_nugget");
                final ResourceLocation name = new ResourceLocation(AgriCraftTFCTNGIntegration.instance.getModId(), "combine_nugget_" + type.name().toLowerCase());
