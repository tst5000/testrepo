package com.tst5000.agricrafttfctngintegration.api.v1.plant;

import com.tst5000.agricrafttfctngintegration.api.v1.crop.IAgriCrop;
import com.tst5000.agricrafttfctngintegration.api.v1.misc.IAgriRegisterable;
import com.tst5000.agricrafttfctngintegration.api.v1.render.RenderMethod;
...
/**
 * This interface is used both for you to read the AgriCraftTFCTNGIntegration CropPlants as well as coding your own.
...
public interface IAgriPlant extends IAgriRegisterable {
    ...
    /**
     * Retrieves the base growth time of the given plant.
     * @return The base growth time (in TFC months) of the plant.
     */
    double getGrowthTimeBase();
     ...
     * block is 15. For AgriCraftTFCTNGIntegration specifically, the conventional number of growth stages is 8.
     *
    ...
    // =========================================================================
    /**
     * Gets the texture that should be used for the AgriCraftTFCTNGIntegration auto-generated seed, in the case that
