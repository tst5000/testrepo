package com.tst5000.agricrafttfctngintegration.api.v1.render;

/**
 * This enum is used to decide how AgriCraftTFCTNGIntegration handles the rendering of plants on crop sticks
 */
public enum RenderMethod {
    ...
    TALL_HASHTAG,
    /**
     * AgriCraftTFCTNGIntegration will not render anything, but will forward the call to the ICropPlant object, use
