package com.tst5000.agricrafttfctngintegration.farming;
...
public class PlantStats implements IAgriStat, IAgriAdapter<IAgriStat> {
    ...
    public boolean addStats(Consumer<String> lines) {
        try {
            lines.accept(MessageFormat.format(AgriCraftConfig.STAT_FORMAT, AgriCore.getTranslator().translate("agricraft_tooltip.growth"), getGrowth(), AgriCraftConfig.cropStatCap));
            lines.accept(MessageFormat.format(AgriCraftConfig.STAT_FORMAT, AgriCore.getTranslator().translate("agricraft_tooltip.gain"), getGain(), AgriCraftConfig.cropStatCap));
            lines.accept(MessageFormat.format(AgriCraftConfig.STAT_FORMAT, AgriCore.getTranslator().translate("agricraft_tooltip.strength"), getStrength(), AgriCraftConfig.cropStatCap));
            return true;
