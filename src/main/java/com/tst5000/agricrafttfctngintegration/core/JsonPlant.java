...
import com.tst5000.agricrafttfctngintegration.api.v1.util.BlockRange;
...
import com.tst5000.agricrafttfctngintegration.farming.growthrequirement.GrowthReqBuilder;
...
import com.tst5000.agricrafttfctngintegration.renderers.PlantRenderer;
...
public class JsonPlant implements IAgriPlant {
    ...
    @Override
    public double getGrowthTimeBase() {
        return plant.getGrowthTime() * CalendarTFC.CALENDAR_TIME.getDaysInMonth() * ICalendar.TICKS_IN_DAY;
    }
