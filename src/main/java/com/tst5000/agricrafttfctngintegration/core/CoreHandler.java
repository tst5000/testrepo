...
import com.agricrafttfctngintegration.agritfccore.json.AgriLoader;
...
import com.agricrafttfctngintegration.agritfccore.util.ResourceHelper;
...
public final class CoreHandler {
    ...
    public static void loadJsons() {
        // Load the core!
        AgriCore.getLogger("agricraft").info("Attempting to read AgriCraftTFCTNGIntegration JSONs!");
        ...
        AgriCore.getLogger("agricraft").info("Finished trying to read AgriCraftTFCTNGIntegration JSONs!");
    }
